      ...
      <div className="w-full max-w-md bg-[#1a1a1a] rounded-2xl p-8 shadow-xl border border-[#2a2a2a]">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-white">
            kliipse <span className="text-[#ADFF2F]">로그인</span>
          </h1>
        ...
        <p className="mt-6 text-center text-sm text-gray-400">
          계정이 없으신가요?{" "}
          <Link href="/signup" className="text-[#ADFF2F] hover:underline font-medium">
            회원가입
          </Link>
        </p>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] text-white">로딩중...</div>}>
      <LoginPageContent />
    </Suspense>
  );
}
